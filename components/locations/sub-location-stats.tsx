...
interface SubLocationStatsProps {
  location: string
  stats: Stat[]
}

export function SubLocationStats({ location, stats }: SubLocationStatsProps) {
  return (
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            See why businesses in {location} are choosing LeadsObtainer to accelerate their growth
          </p>
        </div>
