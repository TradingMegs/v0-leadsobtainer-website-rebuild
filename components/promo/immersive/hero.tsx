...
export function Hero() {
  ...
  const headlines = {
    A: promoContent.hero.headline,
    B: "Double Your Leads In 30 Days – Guaranteed Or We Pay You $1,000",
  }

  // CTA text variants for A/B testing
  const ctaTexts = {
    A: promoContent.hero.primaryCta,
    B: "Claim Your Free Growth Blueprint",
  }

  // Load Lottie animation
  useEffect(() => {
    // In a real implementation, you would load different animations based on the variant
    fetch("/animations/hero-animation.json")
      ...
      .catch((error) => {
        ...
        // Provide a fallback or default animation if needed
        setLottieData(null)
      })
  }, [variants.heroImage])
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div style={{ opacity, y }} className="absolute inset-0">
          {lottieData ? (
            <Lottie animationData={lottieData} loop={true} className="w-full h-full object-cover opacity-30" />
          ) : (
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center bg-primary/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6"
            >
              <Clock className="h-4 w-4 mr-2 text-primary" />
              <span className="text-sm font-medium">
                Transform your business <span className="font-bold text-primary">{promoContent.hero.timeToResult}</span>
              </span>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-secondary/30 backdrop-blur-sm rounded-2xl p-4 mb-8 max-w-md mx-auto md:mx-0"
            >
            ...
            >
              <Button
                size="lg"
                className={cn(
                  "bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-8 py-6 h-auto relative overflow-hidden group rounded-2xl w-full sm:w-auto",
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-black/80 backdrop-blur-sm border border-primary/30 rounded-2xl p-4 shadow-xl"
              >
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-bold">4X Growth</p>
                    <p className="text-sm text-gray-400">Guaranteed Results</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 bg-black/80 backdrop-blur-sm border border-primary/30 rounded-2xl p-4 shadow-xl"
              >
                <div className="flex items-center">
                  <div className="bg-primary/20 p-2 rounded-full mr-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Time to Results</p>
                  </div>
                </div>
              </motion.div>
            </div>
