    ...
    >
      <div className="container mx-auto max-w-md">
        <motion.div
          ...
          className={cn(
            "bg-secondary/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10",
            variants.formStyle === "A" ? "shadow-xl" : "shadow-2xl border-primary/20",
          )}
        >
          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl font-bold">
                {currentStep === "complete" ? "Application Complete!" : "Start Your Transformation"}
              </h3>
          ...
          <AnimatePresence mode="wait">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={cn(
                        "bg-background/50 border-gray-700 focus:border-primary",
            ...
            {currentStep === "email" && (
              ...
              >
                ...
                <p className="text-center text-xs text-gray-500 mt-4">
                  We'll send your strategy blueprint to this email address.
                </p>
              </motion.div>
            )}
            ...
            {currentStep === "phone" && (
              ...
              >
                ...
                <Button
                  className="w-full bg-primary hover:bg-primary/90 text-white py-6 h-auto rounded-2xl relative overflow-hidden"
                ...
                >
                  {isSubmitting ? (
                    ...
                    <span className="flex items-center">
                      Complete Application <ArrowRight className="ml-2 h-5 w-5" />
                    </span>
                  )}
                </Button>

                <p className="text-center text-xs text-gray-500 mt-4">
                  We'll only use your phone for scheduling your strategy session.
                </p>
              </motion.div>
            )}
            ...
            {currentStep === "complete" && (
              ...
              >
                ...
                <p className="text-gray-400 mb-6">
                  Thank you, {formData.name}! We've sent a confirmation to {formData.email}. Our team will contact you
