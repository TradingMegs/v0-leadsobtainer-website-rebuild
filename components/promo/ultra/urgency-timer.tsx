...
export function UltraUrgencyTimer() {
  const { trackEvent } = useExperiment()
  const [timeLeft, setTimeLeft] = useState({
    days: promoUltraContent.urgency.daysLeft,
    hours: promoUltraContent.urgency.hoursLeft,
    minutes: promoUltraContent.urgency.minutesLeft,
    seconds: promoUltraContent.urgency.secondsLeft,
  })
  const [spotsLeft, setSpotsLeft] = useState(promoUltraContent.urgency.spotsLeft)
    ...
    >
      <div className="container mx-auto max-w-5xl">
        <motion.div
          ...
          className="bg-[#111] border border-blue-500/30 rounded-2xl p-8"
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            ...
            <div className="flex items-center bg-black/50 rounded-lg px-4 py-2 border border-[#333]">
              ...
              <p className="text-sm">
                Price increases by{" "}
                <span className="text-white font-bold">{promoUltraContent.urgency.priceIncrease}</span> when timer ends
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center">
              ...
              <p className="text-sm text-gray-300">
                <span className="font-bold text-white">{spotsLeft + 3} people</span> are viewing this offer right now
              </p>
            </div>
          </div>
        </motion.div>
