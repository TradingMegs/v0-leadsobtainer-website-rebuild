        ...
        <div className="container mx-auto text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <AnimatedText text="Transforming" animationType="wave" className="inline-block" />{" "}
              <AnimatedText text="Local Businesses" animationType="gradient" className="inline-block" />
            </h1>
            ...
            >
              We're on a mission to help local businesses thrive in the digital age with AI-powered growth solutions.
            </motion.p>
