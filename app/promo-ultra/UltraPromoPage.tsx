...
import { Hero } from "@/components/promo/ultra/hero"
import { ValueStack } from "@/components/promo/ultra/value-stack"
import { InteractiveBenefits } from "@/components/promo/ultra/interactive-benefits"
import { SocialProof } from "@/components/promo/ultra/social-proof"
import { UrgencyTimer } from "@/components/promo/ultra/urgency-timer"
import { MultiStepForm } from "@/components/promo/ultra/multi-step-form"
import { ExitIntentOverlay } from "@/components/promo/ultra/exit-intent-overlay"
import { ScrollDepthOverlay } from "@/components/promo/ultra/scroll-depth-overlay"
    ...
    <ExperimentProvider>
      <div className="bg-black text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <section id="get-started" className="py-16 px-4 relative">
          ...
          <UnifiedFooter variant="minimal" bgColor="bg-black" textColor="text-white" accentColor="text-blue-400" />
        </div>
